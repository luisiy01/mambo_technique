// components/schedules/DeleteScheduleModal.tsx
...
export function DeleteScheduleModal({ classNameTitle, onClose, onConfirm }: DeleteScheduleModalProps) {
  if (!classNameTitle) return null;
    ...
    <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl max-w-sm w-full p-6 shadow-xl border border-slate-200 text-center">
        ...
        <h3 className="text-base font-bold text-slate-900 mb-2">
          ¿Eliminar la clase "{classNameTitle}"?
        </h3>
        <p className="text-xs text-slate-500 mb-6">
          Esta acción removerá el horario de tu programación semanal. ¿Estás seguro de continuar?
        </p>
